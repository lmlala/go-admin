...
// @Router /api/v1/ops/onpremise [get]
// @Security Bearer
func (e OpsOnPremise) GetPage(c *gin.Context) {
	s := service.OpsOnPremise{}
	req := dto.OpsOnPremiseGetPageReq{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
	...
	list := make([]models.OpsOnPremise, 0)
	var count int64
...
// @Param data body dto.OnPremiseInsertReq true "私有化项目数据"
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/ops/onpremise [post]
// @Security Bearer
func (e OpsOnPremise) Insert(c *gin.Context) {
	s := service.OpsOnPremise{}
	req := dto.OnPremiseInsertReq{}

	log.Info("on-premise add request: ", req)
...
// @Accept  application/json
// @Product application/json
// @Param data body dto.OpsOnPremiseUpdateReq true "body"
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/ops/onpremise/{onPremiseId} [put]
// @Security Bearer
func (e OpsOnPremise) Update(c *gin.Context) {
	s := service.OpsOnPremise{}
	req := dto.OnPremiseUpdateReq{}

	log.Info("on-premise update request: ", req)
...
// @Description 删除私有化项目
// @Tags 私有化项目
// @Param on_premise_id path int true "onPremiseId"
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/ops/onpremise [delete]
// @Security Bearer
func (e OpsOnPremise) Delete(c *gin.Context) {
	s := service.OpsOnPremise{}
	req := dto.OnPremiseById{}

	log.Info("on-premise delete request: ", req)
